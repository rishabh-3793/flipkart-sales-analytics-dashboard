...
└── README.md
```
*(Update to match your actual file names and folders.)*

## 🚀 How to Use

1. Clone this repository
2. Open `FlipMart_Sales_Dashboard.pbix` in Power BI Desktop
3. Refresh the data source if needed (File > Options and settings > Data source settings)
4. Explore the dashboard using the date range and shipping mode filters

## 📌 Notes

- Map and filled map visuals are disabled by default in this report. To enable them: **File > Options and settings > Options > Global > Security**.
